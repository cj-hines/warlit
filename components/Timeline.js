...
import vis from 'vis'; // Ensure vis is imported correctly
...
const Timeline = () => {
  useEffect(() => {
    ...
    const handleFilterAll = () => filterData('all');
    const handleFilterEvents = () => filterData('event');
    const handleFilterFilm = () => filterData('film');
    const handleFilterNovel = () => filterData('novel');
    const handleFilterPoetry = () => filterData('poetry');
    const handleFilterNews = () => filterData('news');
    const handleFilterOther = () => filterData('other');
    ...
    document.getElementById('filter-all').addEventListener('click', handleFilterAll);
    document.getElementById('filter-events').addEventListener('click', handleFilterEvents);
    document.getElementById('filter-film').addEventListener('click', handleFilterFilm);
    document.getElementById('filter-novel').addEventListener('click', handleFilterNovel);
    document.getElementById('filter-poetry').addEventListener('click', handleFilterPoetry);
    document.getElementById('filter-news').addEventListener('click', handleFilterNews);
    document.getElementById('filter-other').addEventListener('click', handleFilterOther);
    ...
    return () => {
      ...
      document.getElementById('filter-all').removeEventListener('click', handleFilterAll);
      document.getElementById('filter-events').removeEventListener('click', handleFilterEvents);
      document.getElementById('filter-film').removeEventListener('click', handleFilterFilm);
      document.getElementById('filter-novel').removeEventListener('click', handleFilterNovel);
      document.getElementById('filter-poetry').removeEventListener('click', handleFilterPoetry);
      document.getElementById('filter-news').removeEventListener('click', handleFilterNews);
      document.getElementById('filter-other').removeEventListener('click', handleFilterOther);
      document.getElementById('searchInput').removeEventListener('input', handleSearchInput);
      document.getElementById('searchButton').removeEventListener('click', handleSearchButton);
    };
  }, []);
}
